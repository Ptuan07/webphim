                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim Thuộc Năm</a> »
                                    ...
                                    <span class="breadcrumb_last" aria-current="page"><a title="{{ $year_bread }}" href="{{ url('year/'.$year_bread) }}">{{ $year_bread }}</a></span> »
                                    @endfor
                                </span>
                            </span>
                        </div>
        ...
        <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
            <section>
                <div class="section-bar clearfix">
                    <h1 class="section-title"><span>Năm : {{ $year_bread }}</span></h1>
                </div>
                <div class="section-bar clearfix">
                    <div class="row">
