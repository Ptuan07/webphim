                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{ $movie->title }}</a> »
                                    <span><a href="{{ route('country', [$movie->country->slug]) }}">{{ $movie->title }}</a> »
                                            ...
                                            @foreach ($episode_movie as $key => $ser_mov)
                                                @if ($ser_mov->server == $ser->id)
                                                    <li class="halim-episode"><span
                                                            class="halim-btn halim-btn-2  halim-info-1-1 box-shadow">{{ $ser->title }}</span>
                                                    </li>
                                                            ...
                                                            @if ($epi->server == $ser->id)
                                                                <a
                                                                    ...
                                                                    <li class="halim-episode"><span
                                                                            ...
                                                                            title="Xem phim {{ $movie->title }} - Tập {{ $epi->episode }} -{{ $movie->name_eng }} - {{ $movie->vietsub }} "
                                                                            data-h1="{{ $movie->title }} - tập {{ $epi->episode }}">{{ $epi->episode }}</span>
                                                                    </li>
                                                                </a>
                                                            @endif
                                                        @endforeach
