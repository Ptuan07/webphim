...
<head>
    ...
    <meta name="keywords" content="Admin WEBSITE PHIM" />
                ...
                <aside class="sidebar-left">
                    <nav class="navbar navbar-inverse">
                        <div class="navbar-header">
                            ...
                            <h1>
                                <a class="navbar-brand" href="{{ url('/login') }}"><span
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="sidebar-menu">
                                <li class="header">QUẢN LÝ WEBSITE PHIM</li>
                                <li class="treeview">
                                    <a href="{{ url('/home') }}">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('category.index') }}"><i
                                                    class="fa fa-angle-right"></i>Liệt kê danh mục</a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('country.index') }}"><i
                                                    class="fa fa-angle-right"></i>Liệt kê quốc gia</a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('episode.index') }}"><i
                                                    class="fa fa-angle-right"></i>Liệt kê tập phim</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <ul>
                        <li class="dropdown profile_details_drop">
                            ...
                            <ul class="dropdown-menu drp-mnu">
                                ...
                                {{-- <li>
                                    <a href="{{ route('user.edit', Auth::user()->id) }}"><i class="fa fa-user"></i> My Account</a>
                                </li> --}}
                                <li>
                                    <a href="{{ route('user.edit', Auth::user()->id) }}"><i class="fa fa-suitcase"></i> Profile</a>
                                </li>
                                <li>
                                    <form class="fa fa-sign-out" action="{{ route('logout') }}" method="POST">
                                        @csrf
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="col_3">
                    ...
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            <i class="pull-left fa fa-file-video-o user1 icon-rounded"></i>
    ...
    <script type="text/javascript">
        $('.select-season').change(function() {
            ...
            $.ajax({
                ...
                success: function() {
                    alert('Thay đổi phim theo mùa ' + season + ' thành công')
                }
        ...
        $(document).on('change', '.file_image', function() {
            ...
            $.ajax({
                ...
                success: function() {
                    location.reload();
                    $('#success_image').html(
                        '<span class="text-success">Cập nhập hình ảnh thành công</span>');
                }
            });
        });
    </script>
